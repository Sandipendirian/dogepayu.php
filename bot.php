...
if(!$logout){
	...
	$login = "https://dogepayu.xyz//auth/login";
	$r = post($login,$data);
	goto cek;
}
print "Login Sukses";
...
echo merah . "----------------------" . reset . "\n";
while(true){
	$faucet = "https://dogepayu.xyz/faucet/currency/doge";
	$r = get($faucet);
	...
	$claim = "https://dogepayu.xyz/faucet/verify/doge";
	$r = post($claim,$data);
